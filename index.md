...
- **64,930 contracts** worth **$97.69 billion**
- 21,789 unique suppliers
- 127 federal agencies
- [View Dataset](data/austender_2025_contracts.csv)

**ACT Government**
- **1,296 contracts** worth **$1.64 billion**
- 772 unique suppliers
- 10 directorates
- [View Dataset](data/act_contracts_2025.csv)
...
All datasets are available under Creative Commons Zero (CC0) license:

- [Federal Contracts CSV](data/austender_2025_contracts.csv) (64,930 contracts)
- [ACT Contracts CSV](data/act_contracts_2025.csv) (1,296 contracts)
- [GitHub Repository](https://github.com/taxpayer-money/act-contracts)

---

## 🔍 About This Analysis

This is an independent analysis of publicly available government procurement data. Data sources:
- **Federal**: [AusTender OCDS API](https://api.tenders.gov.au/)
- **ACT**: [ACT Government Tenders Portal](https://www.tenders.act.gov.au/)
